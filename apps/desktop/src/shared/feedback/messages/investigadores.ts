export const investigadores = {
  ...
  eventos: {
    ...
    expandir: "Ver eventos",
    colapsar: "Ocultar eventos",
    agregar: "Añadir evento",
    recargar: "Recargar eventos",
    eliminar: "Eliminar evento",
    cargando: "Cargando eventos...",
    sinEventos: (nombre: string) => `${nombre} no registra eventos académicos.`,
    modalTitle: "Nuevo evento académico",
    ...
    successCrear: "Evento creado correctamente.",
    successEliminar: "Evento eliminado correctamente.",
    errorOperacion: "Error en operación de eventos",
    eliminarConfirmar: "Eliminar",
    confirmarEliminarTitulo: "Eliminar evento",
    confirmarEliminar: (nombre: string) => `¿Eliminar el evento "${nombre}"?`,
  } as const,
  formaciones: {
