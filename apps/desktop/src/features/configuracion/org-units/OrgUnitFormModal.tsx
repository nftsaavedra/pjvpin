    ...
    try {
      if (isEdit && initial) {
        await actualizarOrgUnit(initial.id_org_unit, {
          ...
          ror_id: rorId.trim() || null,
          isni_id: isniId.trim() || null,
          scopus_id: scopusId.trim() || null,
          sector_institucional: sectorInstitucional || null,
          tipo_dependencia: isSubunidad ? tipoDependencia || null : null,
          tipo_educacion_superior: tipoEducacionSuperior || null,
          ciiu_codigo: ciiuCodigo.trim() || null,
          es_publica: esPublica,
          parent_id: parentId || null,
          legal_name: legalName.trim() || null,
          acronimo: acronimo.trim() || null,
          web_site: webSite.trim() || null,
          direccion: direccion.trim() || null,
          pais: pais.trim().toUpperCase() || null,
          descripcion: descripcion.trim() || null,
          rin_id: rinId.trim() || null,
          sunedu_clasificacion: suneduClasificacion.trim() || null,
          sunedu_estado: suneduEstado.trim() || null,
          sunedu_resolucion: suneduResolucion.trim() || null,
          perucris_uuid: perucrisUuid.trim() || null,
          perucris_handle: perucrisHandle.trim() || null,
        });
